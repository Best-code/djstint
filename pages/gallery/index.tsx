...
const Gallery: NextPage = ({feed}: any) => {
    ...
    return (
        ...
        <div className="w-screen py-12 flex justify-center bg-gradient-to-b from-black to-light font-avenir">
            <div className=" h-fit grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-between">
